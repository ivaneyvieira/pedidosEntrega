...
object Templates {
  val rootStyle = DynamicReports.stl.style().setPadding(2)
  val boldStyle = DynamicReports.stl.style(rootStyle).bold()
  val italicStyle = DynamicReports.stl.style(rootStyle).italic()
